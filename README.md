...
The whole app is a single self-contained HTML file — no build step, no dependencies, no bundler.
...
In `index.html`, replace the placeholder with your n8n webhook:

```javascript
const WEBHOOK_URL = "https://YOUR_N8N_INSTANCE.app.n8n.cloud/webhook/ask-ai";
```
